# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-06 08:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('account_head', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='head_name', to='accounting.AccountHead')),
